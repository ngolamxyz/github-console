...
7. You can use docker
  ...
  - Run `sudo docker run -dp 3000:3000 -v "/var/db:/var/db" -e GITHUB_CLIENT_ID=<your-client-id> -e GITHUB_CLIENT_SECRET=<your-client-secret> -e SESSION_SECRET_KEY=<your-secret-key github-console`
---
## Reference
